...
export const minimax = (chessState, depth, alpha, beta, maximizingPlayer = true) => {
    if (depth === 0 || chessState.gameOver) {
        const ev = evaluate(chessState, maximizingPlayer && chessState.mover.current === Color.white);
