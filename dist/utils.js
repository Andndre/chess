    ...
    for (let row of fen.split(' ')[0].split('/')) {
        for (let char of row) {
            ...
            switch (char.toLowerCase()) {
                case 'p':
                    board[index] = Piece.pawn;
                    break;
                case 'b':
                    board[index] = Piece.bishop;
                    break;
                case 'k':
                ...
                case 'q':
                    ...
                    break;
                case 'r':
                    board[index] = Piece.rook;
                    break;
                case 'n':
                    board[index] = Piece.knight;
                    break;
            }
...
function arrayFillRange(arr, start, end, value) {
